          ...
          <div class="input_box">
            <div class="flex4">
             ...
             <div class="flex4">
              ...
              <div class="input">
                <dict-select v-model="searchParam.dimension" dict-type-id="Dimension" placeholder="请选择" />
              </div>
            </div>
            <!--<div class="flex4">
              <div class="title">
...
export default {
  ...
  methods: {
    ...
    async downloadFile() {
      ...
      const searchList = {
        estY: this.searchParam.rebateYm,
        estM1: this.searchParam.bookYm1,
        estM2: this.searchParam.bookYm2,
        dimension: this.searchParam.dimension,
        fileName: 'rpt001.rpx'
      }
      ...
      //   return false
      // }
      // searchList.EstM1 = searchList.rebateYm + '-' + searchList.bookYm1
      // searchList.EstM2 = searchList.rebateYm + '-' + searchList.bookYm2
      console.log(searchList)
      const res = await downloadList(searchList)
      if (res && res.success) {
