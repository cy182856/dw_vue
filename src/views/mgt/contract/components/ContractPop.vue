          ...
          <div class="dialog-search-box middle-input">
            <el-form ref="searchForm" :model="form" label-width="80px" label-position="left">
              <el-row type="flex" justify="space-between">
                <el-col :span="7">
                  <el-form-item label="合同编号:" prop="identiferNum">
                    <el-input v-model="searchParam.params.identiferNum" />
                  </el-form-item>
                </el-col>
                <el-col :span="7">
                  <el-form-item label="合同名称:" prop="contractName">
                    <el-input v-model="searchParam.params.contractName" />
                  </el-form-item>
                </el-col>
                <el-col :span="7">
          ...
          <div class="dialog-table-box">
            ...
            >
              <el-table-column
                ...
                width="55"
              />
              <el-table-column prop="identiferNum" label="合同编号" min-width="100" />
              <el-table-column prop="contractName" label="合同名称" min-width="160" />
              <el-table-column label="合同类型" min-width="80">
                <template slot-scope="scope">
                  <dict-write dict-type-id="ContractType" :value="scope.row.contractType" />
                </template>
              </el-table-column>
...
<script>
import { getPopList } from '@/api/mgt/contract.js'
