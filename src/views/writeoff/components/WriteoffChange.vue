      ...
      <el-collapse v-model="activeNames">
        ...
        <el-collapse-item name="2">
          ...
          <div class="input_box">
            <div class="flex3">
              ...
              <div class="input">
                <milli-input v-model="writeoff.actPromotion" to-fixed-num="2" class="input" maxlength="25" :disabled="true" />
              </div>
            </div>
            <div class="flex3">
              <div class="title">
        ...
        <el-collapse-item name="3">
          ...
          >
            ...
            <el-table-column prop="col01" label="备注" min-width="100" align="right" />
          </el-table>
        </el-collapse-item>
...
export default {
  ...
  methods: {
    async fetchData() {
      ...
      // console.log(this.$route.query.id, 'this.$route.query.id222')
      ...
      if (res && res.success) {
        ...
        this.$emit('change', this.writeoff)
      }
