  ...
  <div class="apply">
    ...
    <div class="content content-light">
      <ul class="operation-box">
        ...
        <li class="operation-item" @click="downloadFileSeeCsv">
          <span
            class="operation-circle circle-middle-btn btn-light-color bluebg"
          ><i
            class="el-icon-download"
...
import { handleSave, handleApproval, getFinaceList, getFinaceSeeList, downloadFileCsv, downloadFileSeeCsv, downloadFixFee, reqPayDownload, reqPayDownloadSync, dataStorageDeptSave, billingDownloadFixFee, invTempDownloadFixFee } from '@/api/writeoff/finance.js'
...
export default {
  ...
  methods: {
    ...
    async fetchData() {
      ...
      const res = await getFinaceSeeList(this.searchParam)
      if (res && res.success) {
    ...
    handleClose() {
     ...
     downloadFileSeeCsv() {
      downloadFileSeeCsv(this.searchParam)
    },
    handleSave() {
