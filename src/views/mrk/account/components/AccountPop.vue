                ...
                <el-form ref="searchForm" :model="form" label-width="80px" label-position="left">
                  <el-row type="flex" justify="space-between">
                    <el-col :span="7">
                      ...
                      <el-input v-model="searchParam.params.identiferNum" placeholder="代理商编号" />
                      <!-- </el-form-item> -->
                    </el-col>
                    <el-col :span="7">
                      <!-- <el-form-item :label="'代理商名称'" prop="accountName"> -->
                      <el-input v-model="searchParam.params.accountName" placeholder="代理商名称" />
                      <!-- </el-form-item> -->
                    </el-col>
                    <el-col :span="7">
                      <!-- <el-form-item :label="'区域'" prop="salesOffice"> -->
                      <!-- <el-form-item :label="$t('mrk.account.salesOffice')" prop="salesOffice"> -->
            ...
            <div class="footer-box">
              <div class="dialog-table-box">
                ...
                >
                  ...
                  <el-table-column prop="custCode" :label="'代理商编号'" min-width="150" />
                  <el-table-column prop="custName" :label="'代理商名称'" min-width="200" show-overflow-tooltip />
                  <!-- <el-table-column prop="salesOffice" :label="$t('mrk.account.salesOffice')" min-width="100">
                <template slot-scope="scope">
                  <dict-write dict-type-id="salesOffice" :value="scope.row.salesOffice" />
                </template>
              </el-table-column> -->
                </el-table>
              </div>
