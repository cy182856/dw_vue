        ...
        >
          ...
          <el-form-item prop="">
            <el-row type="flex" :gutter="5" justify="space-between">
              ...
              <el-col :span="16">
                <el-select v-model="statusValue2" clearable>
                  <el-option value="" label="全部" />
      ...
      <div class="table-bg-box search-list-table">
        <div ref="tables" style="height: 100%">
          ...
          >
            ...
            <el-table-column
              prop="visitNum2"
              :label="$t('sale.workplan.visitNum2')"
              min-width="120"
            />
            <el-table-column
              prop="visitNum3"
              :label="$t('sale.workplan.visitNum3')"
              min-width="100"
            />
            <el-table-column
              prop="visitNum4"
              :label="$t('sale.workplan.visitNum4')"
              min-width="100"
            />
            <el-table-column :label="$t('sale.rect.status')">
              <template> 巡店中 </template>
            </el-table-column>
          </el-table>
        </div>
      </div>
...
export default {
  ...
  methods: {
    toAdd() {
      this.$router.push({ path: '/sale/workplan/todo' })
    },
    toEdit() {
      if (this.multipleSelection.length <= 0) {
        ...
        const wn = this.multipleSelection[0].id === 2
        this.$router.push({ path: '/sale/workplan/todo?wn=' + wn })
      }
    },
