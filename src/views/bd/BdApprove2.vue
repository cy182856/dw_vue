  ...
  <div class="apply">
    ...
    <div class="content content-light">
      <ul class="operation-box">
        ...
        <li class="operation-item" @click="handleDistrictSummary">
          <span class="operation-circle circle-middle-btn btn-light-color bluebg"><i class="iconfont iconfuzhi" /></span>
          <span class="operation-text">地区别汇总</span>
        </li>
        <li class="operation-item">
          <span class="operation-circle circle-middle-btn btn-light-color bluebg"><i class="iconfont iconfuzhi" /></span>
          <span class="operation-text">XX别汇总</span>
        </li>
        <li class="operation-item">
          <span class="operation-circle circle-middle-btn btn-light-color bluebg"><i class="iconfont iconfuzhi" /></span>
          <span class="operation-text">XX别汇总</span>
        ...
        <div ref="tables" style="height: 100%;">
          ...
          >
            ...
            <el-table-column prop="salesOffice" label="Sales Office" min-width="100" align="center">
              <template slot-scope="scope">
                <router-link :to="{path:'/bd/approve1'}">
                  {{ scope.row.salesOffice }}
                </router-link>
              </template>
            </el-table-column>
...
export default {
  ...
  methods: {
    async fetchData() {
      ...
      for (var i = 1; i < 4; i++) {
        var d = {
          id: i,
          children: [],
          salesOffice: this.salesOffice[i - 1].label,
          bdUser: '担当' + i,
          agent: '客户' + i,
          state: '已确认',
    ...
    handleDistrictSummary() {
      window.open(process.env.VUE_APP_BI_URL + '/decision/v10/entry/access/acccb892-85ed-41c8-8194-80d306d0af54?preview=true&__bypagesize__=false', '_blank')
    },
    handleApprove(type) {
