          ...
          <div class="el-form-item">
            <div class="el-form-item__content">
              <el-row type="flex" :gutter="5" justify="space-between">
                ...
                <el-col :span="16">
                  <el-date-picker v-model="searchParam.params.procEndTimeFrom" :placeholder="$t('comm.from')" type="date" value-format="yyyy-MM-dd" />
                  <span style="margin: 0 5px">{{ $t('dashboard.to') }}</span>
                  <el-date-picker v-model="searchParam.params.procEndTimeTo" :placeholder="$t('comm.to')" type="date" value-format="yyyy-MM-dd" />
                </el-col>
              </el-row>
            </div>
          </div>
    ...
    <div class="content content-light">
      <div class="table-bg-box search-list-table">
        <div ref="tables" style="height: 100%;">
          <el-table ref="table" v-loading="isLoading" :data="finishedList" border stripe style="width: 100%;" height="100%">
            ...
            <el-table-column prop="endTime" :label="$t('workflow.endTime')" align="center" />
          </el-table>
        </div>
      </div>
