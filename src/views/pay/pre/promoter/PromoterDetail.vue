  ...
  <div class="summary">
    ...
    <div class="detail">
      <ul class="operation-box dialog-btn-box dialog-btn-box-detail">
        ...
        <!-- 编辑 -->
        <li v-if="withdraw.workflowFlag === '0' && withdraw.lastFlag === 1" class="operation-item" @click="handleEdit()">
        ...
        <li v-if="!action" class="operation-item" @click="handleCopy">
          <span class="operation-circle circle-middle-btn btn-light-color bluebg">
            <i class="iconfont iconfuzhi" /></span>
    ...
    <div v-if="approveHisDialog" class="approveHis">
      <process-detail
        :key="withdraw.workflowProcessInstId"
        :is-show="approveHisDialog"
        :title=" $t('component.taskApprove.detailedProcess') + withdraw.workflowProcessInstId"
        :process-inst-id="withdraw.workflowProcessInstId"
        @close="approveHisDialog = false"
      />
    </div>
