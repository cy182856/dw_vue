<template>
  ...
  <div class="summary">
      ...
      <el-collapse v-model="activeNames">
        ...
        <el-collapse-item name="2">
          ...
          <div class="input_box">
            ...
            <div class="flex3">
              ...
              <div class="input">
                <dict-select v-model="withdraw.currency" dict-type-id="Currency" />
              </div>
            </div>
          </div>
          <div class="input_box">
            <div class="flex1">
              ...
              <div class="input">
                <el-input v-model="withdraw.paymentRemark" />
              </div>
            </div>
          </div>
        </el-collapse-item>
        <el-collapse-item name="3">
          ...
          >
            ...
            <el-table-column :label="$t('pay.pre.promoter.motionIdentiferNum')" width="170">
              <template slot-scope="scope">
            ...
            <el-table-column :label="$t('pay.pre.promoter.subjectNum')" width="170">
              <template slot-scope="scope">
                <el-input v-model="scope.row.accountNum" clearable />
              </template>
            </el-table-column>
            <el-table-column :label="$t('pay.pre.promoter.subjectName')" width="170">
              <template slot-scope="scope">
                <el-input v-model="scope.row.accountName" clearable />
              </template>
            </el-table-column>
            <el-table-column :label="$t('pay.pre.promoter.ph2Num')" width="170">
              <template slot-scope="scope">
                <el-input v-model="scope.row.ph2Num" clearable />
              </template>
            </el-table-column>
            <el-table-column :label="$t('pay.pre.promoter.ph2Name')" width="170">
              <template slot-scope="scope">
                <el-input v-model="scope.row.ph2Name" clearable />
              </template>
            </el-table-column>
            <!-- <el-table-column :label="$t('pay.pre.promoter.localChainNum')" width="170">
              <template slot-scope="scope">
            ...
            <el-table-column :label="$t('pay.pre.promoter.localChainName')" width="170">
              <template slot-scope="scope">
                <el-input v-model="scope.row.localChainName" clearable />
              </template>
            </el-table-column> -->
            <el-table-column :label="$t('pay.pre.promoter.subBrandNum')" width="170">
              <template slot-scope="scope">
                <el-input v-model="scope.row.subBrandNum" clearable />
              </template>
            </el-table-column>
            <el-table-column :label="$t('pay.pre.promoter.subBrandName')" width="170">
              <template slot-scope="scope">
                <el-input v-model="scope.row.subBrandName" clearable />
              </template>
            </el-table-column>
            <el-table-column :label="$t('pay.pre.promoter.salesOfficeNum')" width="170">
              <template slot-scope="scope">
                <el-select v-model="scope.row.salesOfficeNum" placeholder="请选择">
                  <el-option
            ...
            <el-table-column :label="$t('pay.pre.promoter.cg5Num')" width="170">
              <template slot-scope="scope">
                <el-input v-model="scope.row.cg5Num" clearable />
              </template>
            </el-table-column>
            <el-table-column :label="$t('pay.pre.promoter.expenseSideNum')" width="170">
              <template slot-scope="scope">
                <el-input v-model="scope.row.expenseSideNum" clearable />
              </template>
            </el-table-column>
            <el-table-column :label="$t('pay.pre.promoter.expenseSideName')" width="170">
              <template slot-scope="scope">
                <el-input v-model="scope.row.expenseSideName" clearable />
              </template>
            </el-table-column>
            <el-table-column :label="$t('pay.pre.promoter.amount')" width="170">
              <template slot-scope="scope">
                <milli-input v-model="scope.row.amount" to-fixed-num="2" />
              </template>
            </el-table-column>
            <el-table-column :label="$t('pay.pre.promoter.costCenterNum')" width="170">
              <template slot-scope="scope">
                <el-input v-model="scope.row.costCenterNum" clearable />
              </template>
            </el-table-column>
            <el-table-column :label="$t('pay.pre.promoter.prewithdrawUses')" width="170">
              <template slot-scope="scope">
                <el-input v-model="scope.row.prewithdrawUses" clearable />
              </template>
            </el-table-column>
            <el-table-column :label="$t('pay.pre.promoter.planUseDate')" width="170">
              <template slot-scope="scope">
        ...
        <el-collapse-item name="5">
          <span slot="title" class="collapse-title">{{ $t("pay.pre.promoter.attachmentFile") }}</span>
          <div class="input_box">
            <div class="flex1">
              <div class="title">
    ...
    <div class="depSelect">
      <el-dialog :title="'部门选择'" :visible.sync="selectDepartmentDialog" append-to-body custom-class="content-dialog-userSelect" width="25%" :close-on-click-modal="false">
        <user-org-tree tree-type="department" :multiple="false" @select="handleTreeSelect" @cancel="selectDepartmentDialog = false" @clear="handleTreeClear" />
      </el-dialog>
    </div>
  </div>
</template>
