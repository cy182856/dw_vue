      ...
      <el-scrollbar>
        <el-form ref="form" class="search-form default-input" label-position="left" :model="searchParam.params">
          ...
          <!-- <el-form-item>
            <el-row type="flex" :gutter="5" justify="space-between">
              <el-col :span="8">
                {{ $t('pay.pre.motion.prewithdrawType') }}:
              </el-col>
              <el-col :span="16">
      ...
      <div class="table-bg-box search-list-table">
        <div ref="tables" style="height: 100%">
          ...
          >
            ...
            <el-table-column prop="identiferNum" :label="$t('pay.pre.motion.identiferNum')" min-width="100" align="center">
              <template slot-scope="scope">
                <router-link :to="{ path: '/pay/pre/motion/detail', query: { id: scope.row.id }, }">
                  {{ scope.row.identiferNum }}
                </router-link>
              </template>
            </el-table-column>
            <!-- <el-table-column prop="prewithdrawType" :label="$t('pay.pre.motion.prewithdrawType')" min-width="110" align="center" /> -->
            <el-table-column prop="motionIdentiferNum" :label="$t('pay.pre.motion.motionIdentiferNum')" min-width="120" align="center" />
            <el-table-column prop="subjectNum" :label="$t('pay.pre.motion.subjectNum')" min-width="110" align="center" />
            <el-table-column prop="subjectName" :label="$t('pay.pre.motion.subjectName')" min-width="150" align="center" show-overflow-tooltip />
            <!-- <el-table-column prop="localChainNum" :label="$t('pay.pre.motion.localChainNum')" min-width="120" align="center" />
            <el-table-column prop="localChainName" :label="$t('pay.pre.motion.localChainName')" min-width="150" align="center" show-overflow-tooltip /> -->
            <el-table-column prop="salesOfficeNum" :label="$t('pay.pre.motion.salesOfficeNum')" min-width="120" align="center" />
            <el-table-column prop="subBrandNum" :label="$t('pay.pre.motion.subBrandNum')" min-width="120" align="center" />
            <el-table-column prop="subBrandName" :label="$t('pay.pre.motion.subBrandName')" min-width="150" align="center" show-overflow-tooltip />
            <el-table-column prop="prewithdrawUses" :label="$t('pay.pre.motion.prewithdrawUses')" min-width="150" align="center" show-overflow-tooltip />
            <el-table-column :label="$t('pay.pre.motion.prewithdrawAmount')" min-width="110" align="right">
              <template slot-scope="scope">
            ...
            <el-table-column prop="planUseDate" :label="$t('pay.pre.motion.planUseDate')" min-width="110" align="center" />
          </el-table>
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    handleCreate() {
      this.$router.push('/pay/pre/motion/edit')
    },
    handleCopy() {
