      ...
      <el-collapse v-model="activeNames">
        ...
        <el-collapse-item name="3">
          ...
          >
            ...
            <el-table-column prop="motionIdentiferNum" :label="$t('pay.pre.motion.motionIdentiferNum')" min-width="170" align="center" />
            <el-table-column prop="accountNum" :label="$t('pay.pre.motion.subjectNum')" min-width="170" align="center" />
            <el-table-column prop="accountName" :label="$t('pay.pre.motion.subjectName')" min-width="170" align="center" />
            <el-table-column prop="ph2Num" :label="$t('pay.pre.motion.ph2Num')" min-width="170" align="center" />
            <el-table-column prop="ph2Name" :label="$t('pay.pre.motion.ph2Name')" min-width="170" align="center" />
            <el-table-column prop="subBrandNum" :label="$t('pay.pre.motion.subBrandNum')" min-width="170" align="center" />
            <el-table-column prop="subBrandName" :label="$t('pay.pre.motion.subBrandName')" min-width="170" align="center" />
            <el-table-column prop="salesOfficeNum" :label="$t('pay.pre.motion.salesOfficeNum')" min-width="170" align="center" />
            <el-table-column prop="cg5Num" :label="$t('pay.pre.motion.cg5Num')" min-width="170" align="center" />
            <el-table-column prop="expenseSideNum" :label="$t('pay.pre.motion.expenseSideNum')" min-width="170" align="center" />
            <el-table-column prop="expenseSideName" :label="$t('pay.pre.motion.expenseSideName')" min-width="170" align="center" />
            <el-table-column :label="$t('pay.pre.motion.amount')" min-width="170" align="right">
              <template slot-scope="scope">
                {{ scope.row.amount | numFormat(2) }}
              </template>
            </el-table-column>
            <el-table-column prop="costCenterNum" :label="$t('pay.pre.motion.costCenterNum')" min-width="170" align="center" />
            <el-table-column prop="prewithdrawUses" :label="$t('pay.pre.motion.prewithdrawUses')" min-width="170" align="center" />
            <el-table-column prop="planUseDate" :label="$t('pay.pre.motion.planUseDate')" min-width="170" align="center" />
          </el-table>
          <div class="input_box">
            <div class="flex3" />
            <div class="flex3" />
