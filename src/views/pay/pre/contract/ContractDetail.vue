...
export default {
  ...
  methods: {
    ...
    handleCopy() {
      this.$router.push({ path: '/pay/pre/contract/edit', query: { id: this.id, copy: true }})
    },
    handleEdit() {
      this.$router.push({ path: '/pay/pre/contract/edit', query: { id: this.id }})
    },
    handleDelete() {
      this.$confirm(this.$t('comm.tip9'), this.$t('comm.tips'), {
        ...
        // if (res && res.success) {
        //   this.$router.push('/pay/pre/contract/list')
        // }
