          ...
          >
            ...
            <el-table-column prop="monitorNo" :label="$t('pay.pay.motion.monitorNo')" min-width="120" align="center">
              <template slot-scope="scope">
                <router-link :to="{path:'/pay/pay/motion/detail',query:{id:scope.row.id}}">
                  {{ scope.row.monitorNo }}
                </router-link>
              </template>
            </el-table-column>
...
export default {
  ...
  methods: {
    ...
    handleCreate() {
      this.$router.push('/pay/pay/motion/edit')
    },
    handleCopy() {
      if (this.multipleSelection && this.multipleSelection.length === 1) {
        this.multipleSelection.forEach((rowData) => {
          this.$router.push({ path: '/pay/pay/motion/edit', query: { id: rowData.id, copy: true }})
        })
      } else {
        this.$message({
          type: 'info',
    ...
    handleEdit() {
      if (this.multipleSelection && this.multipleSelection.length === 1) {
        this.multipleSelection.forEach((rowData) => {
          ...
          this.$router.push({ path: '/pay/pay/motion/edit', query: { id: rowData.id }})
        })
      } else {
        this.$message({
          type: 'info',
