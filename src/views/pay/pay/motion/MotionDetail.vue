...
import MotionInfo from '@/views/pay/pay/motion/components/MotionInfo'
export default {
  name: 'MotionDetail',
  ...
  methods: {
    ...
    handleCopy() {
      this.$router.push({ path: '/pay/pay/motion/edit', query: { id: this.id, copy: true }})
    },
    handleEdit() {
      this.$router.push({ path: '/pay/pay/motion/edit', query: { id: this.id }})
    },
    handleDelete() {
      this.$confirm(this.$t('comm.tip9'), this.$t('comm.tips'), {
        ...
        // if (res && res.success) {
        //   this.$router.push('/pay/pay/motion/list')
        // }
